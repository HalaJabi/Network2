...
public class ARP extends javax.swing.JFrame {
    ...
    String strURLs = "http://127.0.0.1/javap4.php";
     ...
     void f(String ra){
        ...
        for(String f:strArray){
          ...
          //  System.out.println("f: "+f);
            ...
            str=f.split("!");
            if(count!=0){
                String table[]={str[0],str[1],str[2],str[3]};
            jTable1.setModel(dtm);
            String header[] = new String[] { "Index", "IP Address", "MAC Address", "Type" };    
            dtm.setColumnIdentifiers(header);
            dtm.insertRow(0, new Object[] { table[0],table[2],table[1],table[3] });
            }
            count++;
        }
     }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ARP Connection Table");
